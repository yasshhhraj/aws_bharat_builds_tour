...
**Generated:** `2026-09-19T15:01:26.776325Z`
...
|---|---:|---:|---:|---:|
| Policy evaluation | 1050 | 9.359 | 13.654 | 9.932 |
| End-to-end case | 220 | 256.269 | 2409.967 | 966.323 |
...
```bash
MANIFEST_POLICY_ENGINE=cedar CEDAR_ENDPOINT=http://127.0.0.1:18765 python3 scripts/run_evaluation.py --policy-engine cedar --warmup 1 --iterations 10
```
