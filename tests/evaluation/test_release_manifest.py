...
def test_release_manifest_binds_source_fixtures_modes_tests_and_evaluation(tmp_path):
    ...
    assert manifest["runtime"]["requested_model_id"] == report.active_modes["requested_model_id"]
    assert manifest["runtime"]["resolved_model_id"] == report.active_modes["resolved_model_id"]
